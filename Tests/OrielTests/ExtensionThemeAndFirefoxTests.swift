...
final class ExtensionThemeAndFirefoxTests: XCTestCase {
    ...
    func testFirefoxSlugFromStoreURL() {
        ...
        XCTAssertFalse(FirefoxAddonsBridge.userScriptSource.contains("function ensureButton"))
        XCTAssertTrue(FirefoxAddonsBridge.userScriptSource.contains("legacyBtn"))
