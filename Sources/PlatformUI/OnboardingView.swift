    ...
    private var editionPickerPage: some View {
        VStack(spacing: 18) {
            ...
            Text("Choose your edition")
                .font(EditionBranding.productTitleFont(for: environment.settings.edition, size: 28))
    ...
    private func pageContent(_ item: OnboardingPage) -> some View {
        VStack(spacing: 22) {
            ...
            Image(systemName: item.symbol)
                ...
                .padding(.top, 4)
            Text(item.title)
                .font(EditionBranding.productTitleFont(for: environment.settings.edition, size: 26))
                .tracking(EditionBranding.productTitleTracking(for: environment.settings.edition))
                .multilineTextAlignment(.center)
            Text(item.body)
                .font(.body)
